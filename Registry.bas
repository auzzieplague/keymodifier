...
Public Function set_autorun()
    Dim sValue As String
    Dim appname As String
    If (fReadValue("HKCU", "Software\Microsoft\Windows\CurrentVersion\Run", App.EXEName, "S", "", sValue)) <> 0 Then
        MsgBox "Translator is now loaded. I Will start automatically in the future", 64, "Hi There!"
        fWriteValue "HKCU", "Software\Microsoft\Windows\CurrentVersion\Run", App.EXEName, "S", App.Path & "\" & App.EXEName & ".exe"
    End If
End Function
